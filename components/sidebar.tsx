...
const rolePaths: Record<Role, string[]> = {
  ADMIN: [],
  WAREHOUSE: ["/", "/operations", "/shipments", "/deliveries", "/stock-movements", "/materials", "/products", "/warehouses", "/requests"],
  PRODUCTION: ["/", "/operations", "/shipments", "/deliveries", "/materials", "/products"],
  ACCOUNTING: ["/", "/operations", "/orders", "/stock-movements", "/materials", "/products", "/warehouses", "/requests", "/customers", "/factories", "/finance", "/invoices", "/activity"],
  SALES: ["/", "/orders", "/customers", "/products", "/invoices", "/sales", "/influencers"],

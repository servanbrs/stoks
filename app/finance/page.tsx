...
export default function FinancePage() {
  ...
  useEffect(() => { const saved = JSON.parse(localStorage.getItem("stoks_payments") ?? "[]") as Payment[]; setPayments(saved); setParty(new URLSearchParams(window.location.search).get("party")); }, []);
